...
export function InvitationsList({ invitations }: { invitations: InvitationWithCompany[] }) {
  return (
        ...
        {invitations.map((inv) => (
          ...
          >
            <div className="space-y-1">
              <p className="font-medium leading-none">{inv.companyName}</p>
              <div className="flex gap-2 text-sm text-muted-foreground">
                Rola: <Badge variant="secondary" className="text-xs">{inv.role}</Badge>
              </div>
            </div>
